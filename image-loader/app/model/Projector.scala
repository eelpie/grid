...
object Projector {
  ...
  def apply(config: ImageLoaderConfig, imageOps: ImageOperations, s3: S3, processor: ImageProcessor, auth: Authentication, maybeEmbedder: Option[Embedder])(implicit ec: ExecutionContext): Projector
