...
import com.gu.mediaservice.lib.aws.{S3, S3Metadata, S3Object, S3ObjectMetadata, S3Ops}
...
class ImageUploadTest extends AsyncFunSuite with Matchers with MockitoSugar {
  ...
  private implicit val logMarker: MockLogMarker = new MockLogMarker()
    ...
    val mockConfig: ImageUploadOpsCfg = ImageUploadOpsCfg(tempDir, 256, 85d, List(Tiff), "img-bucket", "thumb-bucket", S3.AmazonAwsS3Endpoint)
