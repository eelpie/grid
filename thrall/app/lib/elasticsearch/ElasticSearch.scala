...
class ElasticSearch(
  ...
  def setMigrationInfo(imageId: String, migrationInfo: MigrationInfo, instance: String)(implicit ex: ExecutionContext, logMarker: LogMarker): Future[Response[Any]] = {
  ...
  def migrationAwareIndexImage(id: String, image: Image, lastModified: DateTime, instance: String)
    ...
    def runUpsertIntoMigrationIndexAndReturnEsInfoForCurrentIndex(instance: String): Future[JsObject] = migrationStatus(instance) match {
  ...
  def getImage(id: String, instance: String)(implicit ex: ExecutionContext, logMarker: LogMarker): Future[Option[Image]] = {
  ...
  def getImageVersion(id: String, instance: String)(implicit ex: ExecutionContext, logMarker: LogMarker = MarkerMap()): Future[Option[Long]] = {
  ...
  def updateImageUsages(id: String, usages: Seq[Usage], lastModified: DateTime, instance: String)
  ...
  def updateImageSyndicationRights(id: String, rights: Option[SyndicationRights], lastModified: DateTime, instance: String)
                                  (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def applyImageMetadataOverride(id: String, metadata: Edits, lastModified: DateTime, instance: String)
                                (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def applySoftDelete(id: String, softDeletedMetadata: SoftDeletedMetadata, lastModified: DateTime, instance: String)
                     (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def applyUnSoftDelete(id: String, lastModified: DateTime, instance: String)
                       (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  private def getNextBatchOfImageIdsForDeletion(query: Query, count: Int, deletionType: String, instance: String)
  ...
  private def countTotalReapable(query: Query, deletionType: String, instance: String)
  ...
  def countTotalSoftReapable(isReapable: ReapableEligibility, instance: String)(implicit ex: ExecutionContext, logMarker: LogMarker): Future[Long] =
    countTotalReapable(softReapableQuery(isReapable), "soft", instance)

  def softDeleteNextBatchOfImages(isReapable: ReapableEligibility, count: Int, softDeletedMetadata: SoftDeletedMetadata, instance: String)
  ...
  def countTotalHardReapable(isReapable: ReapableEligibility, daysInSoftDeletedState: Int, instance: String)(implicit ex: ExecutionContext, logMarker: LogMarker): Future[Long] =
    countTotalReapable(hardReapableQuery(isReapable, daysInSoftDeletedState), "hard", instance)

  def hardDeleteNextBatchOfImages(isReapable: ReapableEligibility, count: Int, daysInSoftDeletedState: Int, instance: String)
                                 (implicit ex: ExecutionContext, logMarker: LogMarker): Future[BatchDeletionIds] = {
  ...
  def getInferredSyndicationRightsImages(photoshoot: Photoshoot, excludedImageId: Option[String], instance: String)
  ...
  def getLatestSyndicationRights(photoshoot: Photoshoot, excludedImageId: Option[String], instance: String)
  ...
  def deleteImage(id: String, instance: String)
  ...
  def deleteSingleImageUsage(
    id: String, usageId: String, lastModified: DateTime, instance: String
  )(implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def deleteAllImageUsages(
    id: String, lastModified: DateTime, instance: String
  )(implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def updateUsageStatus(id: String, usages: Seq[Usage], lastModified: DateTime, instance: String)
                       (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def deleteSyndicationRights(id: String, lastModified: DateTime, instance: String)
                             (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def replaceImageLeases(id: String, leases: Seq[MediaLease], lastModified: DateTime, instance: String)
                        (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def addImageLease(id: String, lease: MediaLease, lastModified: DateTime, instance: String)
                   (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def removeImageLease(id: String, leaseId: Option[String], lastModified: DateTime, instance: String)
                      (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def updateImageExports(id: String, exports: Seq[Crop], lastModified: DateTime, instance: String)
                        (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def deleteImageExports(id: String, lastModified: DateTime, instance: String)
                        (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def setImageCollections(id: String, collections: Seq[Collection], lastModified: DateTime, instance: String)
                         (implicit ex: ExecutionContext, logMarker: LogMarker): List[Future[ElasticSearchUpdateResponse]] = {
  ...
  def listImageIdsWithPrefix(prefix: String, instance: String)(
  ...
  def listImageIdsWithUnexpectedFormat(instance: String)(implicit ec: ExecutionContext, logMarker: LogMarker) = {
    val req = search(imagesCurrentAlias(instance))
      .size(scrollPageSize)
      .fetchSource(false)
      .scroll(60.seconds)
