...
class VipsImageOperationsTest extends AnyFunSpec with Matchers with ScalaFutures {
  ...
  describe("resize") {
    it("should output resized image to file in chosen format") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(1000, 800), 95, outputFile, Jpeg, Dimensions(6000, 4000))
    ...
    it("render LAB colour spaces correctly in sRGB") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(800, 600), 95, outputFile, Jpeg, Dimensions(1299, 866))
    ...
    it("render LAB colour spaces correctly as PNG") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(800, 600), 95, outputFile, Png, Dimensions(1299, 866))
    ...
    it("render PNG with alpha correctly") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(800, 600), 95, outputFile, Png, Dimensions(3000, 2000))
