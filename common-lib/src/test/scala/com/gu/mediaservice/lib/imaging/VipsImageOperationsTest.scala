...
class VipsImageOperationsTest extends AnyFunSpec with Matchers with ScalaFutures {
  ...
  describe("resize") {
    it("should output resized image to file in chosen format") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(1000, 800), 95, outputFile, Jpeg)
    ...
    it("render LAB colour spaces correctly in sRGB") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(800, 600), 95, outputFile, Jpeg)
    ...
    it("render LAB colour spaces correctly as PNG") {
      ...
      val resized = imageOperations.resizeImage(fullSizedImage, Dimensions(800, 600), 95, outputFile, Png)
