...
class CropStore(config: CropperConfig) extends S3ImageStorage(config) with CropSpecMetadata {
  ...
  def listCrops(id: String)(implicit instance: Instance): Future[List[Crop]] = {
  ...
  def deleteCrops(id: String)(implicit logMarker: LogMarker, instance: Instance): Future[Unit] = {
